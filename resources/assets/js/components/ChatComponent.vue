                    ...
                    <div class="side-one">
                        ...
                        <div class="row searchBox">
                            <div class="col-sm-12 searchBox-inner">
                                <center>
                                    <h4>People Nearby <small><span class="badge badge-secondary badge-pill">{{ people.length }}</span></small></h4>
                                </center>
                            </div>
                        </div>

                        <div class="row sideBar">
                            <div class="row sideBar-body" v-for="user in people">
                ...
                <div class="col-sm-8 conversation">
                    <div class="row heading">
                        <div class="col-sm-2 col-md-1 col-xs-3 heading-avatar">
                            <div class="heading-avatar-icon">
                                <img :src="chatting.image">
                            </div>
                        </div>
                        <div class="col-sm-8 col-xs-7 heading-name">
                            <a class="heading-name-meta">
                                {{ chatting.fname + ' ' + chatting.lname }}
                            </a>
...
export default {
    ...
    methods: {
        ...
        get_currently_chatting() {
            axios.get('/get-currently-chatting/' + this.phone)
                 .then( (resp) => {
                     this.chatting = resp.data
                 })
        } 
    }
}
